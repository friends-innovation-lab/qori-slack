...
output_options:
  ...
  file_name: "research_plan_research study 5_July 7, 2025.md"
...
prompt: |
  ...
  3. **Additional Goals** - 2-3 supporting goals based on usability and research study 5
  4. **Research Questions** - 3-4 specific questions based on research study 5 and research study 5
  5. **Research Hypotheses** - 2-3 testable hypotheses based on research questions and usability
  6. **Methodology Details** - Specific implementation details for usability
  ...
  8. **Timeline Dates** - Calculate actual dates from July 7, 2025 using standard:
     - Rush: Planning(3d), Recruiting(5d), Interviews(5d), Synthesis(3d), Reporting(2d)
     - Standard: Planning(5d), Recruiting(10d), Interviews(10d), Synthesis(5d), Reporting(5d)
     - Extended: Planning(10d), Recruiting(21d), Interviews(14d), Synthesis(10d), Reporting(7d)
  9. **Tools and Platforms** - Specific tools based on usability selections
  10. **Output Artifacts** - Realistic deliverables based on usability and research study 5

  Requirements:
  - Calculate actual calendar dates from July 7, 2025 using business days only
...
notify:
  - role: research_team
    ...
    message: "🧭 Research plan for research study 5 has been created and saved. standard timeline with usability methodology planned."
  - role: researcher
